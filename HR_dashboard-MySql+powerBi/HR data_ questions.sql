...
FROM hr
WHERE age >= 18
GROUP BY gender    -- saving the output as csv file for further visualisation in powerbi
...
WHERE age >= 18
GROUP BY race
ORDER BY count DESC    -- saving the output as csv file for further visualisation in powerbi
